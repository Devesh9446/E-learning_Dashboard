  ...
  return (
    <div className="mt-24">
      <div className="flex flex-wrap lg:flex-nowrap justify-center gap-4 w-full">
        <div className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg h-44 rounded-xl flex-1 p-8 pt-9 m-3 bg-hero-pattern bg-no-repeat bg-cover bg-center shadow-lg">
        ...
        <div className="flex flex-1 justify-center gap-6 items-center w-full">
          {earningData.map((item) => (
            <div key={item.title} className="bg-white h-44 dark:text-gray-200 dark:bg-secondary-dark-bg flex-1 p-4 pt-9 rounded-2xl shadow-lg">
              <button
                type="button"
      ...
      <div className="flex flex-wrap justify-center gap-10">
        ...
        <div className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg p-6 rounded-2xl shadow-lg md:w-780">
